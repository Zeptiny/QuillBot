...
ANALYZE_SYSTEM_PROMPT = (
    ...
    "</role>\n\n"
    "<instructions>\n"
    "Analise o log/crash report fornecido. Responda em português brasileiro.\n"
    "Baseie-se exclusivamente no conteúdo fornecido. Omita seções que não tiverem ocorrências.\n"
